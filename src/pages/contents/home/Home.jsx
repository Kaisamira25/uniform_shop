...
const imageData = [
  {
    ...
    imageUrl: "https://dongphuctienbao.com/wp-content/uploads/2022/01/91.png.png",
  },
  {
  ...
  },
  {
    ...
    return (
      <div className="home p-4 ">
        ...
        <h1 className="ml-4 border-b-4 mt-4 border-cyan-400 text-2xl font-bold">Danh mục sản phẩm</h1>
          <div className="flex flex-wrap ">
            {imageData.map((item, index) => (
              <div key={index} className="w-full sm:w-1/2 md:w-1/5 lg:w-1/2 xl:w-1/4 p-6">
          ...
          <h1 className="ml-4 border-b-4 mt-4 border-cyan-400 text-2xl font-bold">Sản phẩm mới nhất</h1>
          <div className="flex flex-wrap ">
            {imageData.map((item, index) => (
              <div key={index} className="w-full sm:w-1/2 md:w-1/5 lg:w-1/2 xl:w-1/4 p-6">
                <div className="image-card bg-gray-200  relative">
